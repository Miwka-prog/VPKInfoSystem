...
ActiveRecord::Schema.define(version: 2021_11_20_161222) do
  ...
  create_table "enterprises", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_enterprises_on_user_id", unique: true
  end
  ...
  add_foreign_key "comments", "news", on_delete: :cascade
  add_foreign_key "comments", "users", on_delete: :cascade
  add_foreign_key "enterprises", "users"
  add_foreign_key "news", "users", on_delete: :cascade
  add_foreign_key "products", "enterprises", on_delete: :cascade
end
